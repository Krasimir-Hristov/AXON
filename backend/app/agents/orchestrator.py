...
- **supervisor**:      Entry point for every turn. Binds both handoff tools on the
...
def _build_graph() -> CompiledStateGraph:
    ...
    builder.add_conditional_edges(
        "supervisor",
        _should_continue,
        {"memory_agent": "memory_agent", "youtube_agent": "youtube_agent", END: END},
    )
    # Both sub-agents loop back to supervisor for the final response.
