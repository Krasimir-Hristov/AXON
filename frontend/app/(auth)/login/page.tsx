...
const LoginPage = () => {
  return (
    <main className='relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#13131b]'>
      ...
      />
      {/* Ambient glow */}
      <div className='pointer-events-none absolute left-1/2 top-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#494bd6]/10 blur-[120px]' />
      ...
      <div className='relative z-10 flex w-full max-w-[400px] flex-col items-center px-6'>
        ...
        <div className='mb-12 flex flex-col items-center text-center'>
          <h1
            className='mb-2 bg-gradient-to-r from-[#c0c1ff] to-[#8083ff] bg-clip-text text-[40px] font-semibold leading-tight tracking-[-0.02em] text-transparent'
        ...
        <div className='mt-12 text-center'>
          <p className='text-[12px] font-semibold uppercase tracking-[0.1em] text-[#464554]'>
